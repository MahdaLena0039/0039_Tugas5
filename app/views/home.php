...
<head>
  ...
  <title>Aplikasi Toko 0039</title>
...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="/Index.php.php" class="brand-link">
      ...
      <span class="brand-text font-weight-light">TOKO LENA</span>
    </a>
  ...
  <footer class="main-footer">
    ...
    <strong>&copy; <span id="year"></span> <a href="#">Mahda Lena</a>.</strong> All rights reserved.
  </footer>
